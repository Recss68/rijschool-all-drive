	...
	<div class="section-inner">
		<div class="footer-heading">
			<picture>
				...
				<img
					src="/images/ad_long_white.avif"
					width="70%"
					height="70%"
					alt="rijschool-all-drive-logo"
					loading="lazy"
				/>
			</picture>
			<p>
		...
		<div class="quick-menu-3">
			...
			<div class="menu-icons">
				<a href="https://instagram.com/">
					<svg viewBox="0 0 24 24" fill="#D1D5DC" xmlns="http://www.w3.org/2000/svg"
						...
						></g><g id="SVGRepo_iconCarrier">
							<path
								...
								fill="#D1D5DC"><title>Instagram page</title></path
							>
							<path
				...
				<a href="https://tiktok.com/">
					<svg fill="#D1D5DC" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
						><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
							id="SVGRepo_tracerCarrier"
							stroke-linecap="round"
							stroke-linejoin="round"
